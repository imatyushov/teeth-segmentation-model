...
def train(device, model, train_loader, valid_loader, optimizer, criterion, metric, num_epochs, max_patience=10,
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        train_loss, train_dice = train_one_epoch(device, model, train_loader, optimizer, criterion, metric, epoch,
                                                 num_epochs)
        ...
        if valid_loss < best_loss:
            ...
            # update best loss
            print(
                f"@ epoch {epoch} val_loss decreased from {best_loss:.4f} to {valid_loss:.4f}. Model saved in {model_path}.\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-ne", "--num_epochs", default=20, type=int, help="number of epochs")
